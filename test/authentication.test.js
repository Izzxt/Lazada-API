...
describe('oauth2 app', () => {
  ...
  it('generates an authorize URL', async () => {
    const bundle = {
      ...
      inputData: {
        state: '4444',
        redirect_uri: 'https://zapier.com/dashboard/auth/oauth/return/App138396CLIAPI',
      },
      environment: {
    ...
    expect(authorizeUrl).toBe(
      'https://api.lazada.com.my/oauth/authorize?response_type=code&force_auth=true&redirect_uri=https%3A%2F%2Fzapier.com%2Fdashboard%2Fauth%2Foauth%2Freturn%2FApp138396CLIAPI&client_id=101736'
    );
  });
